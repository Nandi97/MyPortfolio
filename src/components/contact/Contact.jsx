...
const Contact = () => {
    ...
    emailjs.sendForm('service_m384vpx', 'template_rvbuwzp', form.current, 'J9FUA9o9WKbiCTqIq')
      .then((result) => {
                ...
                <form ref={form} onSubmit={sendEmail}>
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            >
                                Your Name<sup className='text-base text-red-600'>*</sup>
                            </label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <input
                            ...
                            <label
                                ...
                                className="peer-focus:font-medium absolute text-sm text-gray-900  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#c7493a] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                            >
                                Your Email<sup className='text-base text-red-600'>*</sup>
                            </label>
                        </div>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                            ...
                            <label
                                ...
                                className="peer-focus:font-medium absolute text-sm text-gray-900  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#c7493a] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                            >
                                Your Message<sup className='text-base text-red-600'>*</sup>
                            </label>
                    </div>
                    <button type="submit" class="btn btn-primary text-[#c7493a]" onClick={() => toast.success('Email Sent')}>Send Message</button>
                </form>
            </div>
        </section>
    )
